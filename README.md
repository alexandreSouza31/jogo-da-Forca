...
3. Clone o projeto 
ex:``` git clone git@github.com:alexandreSouza31/jogo-da-Forca.git```
...
```
jogoDaForca.ConsoleApp\jogoDaForca.ConsoleApp
```
...
3. Siga as instruções no console e tente adivinhar a palavra!
